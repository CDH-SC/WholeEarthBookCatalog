...
# The following script is used to create the graph stored in /graph so that the graph
# can be loaded from disk rather than from the raw data each time
